...
<input name="opcionCondicion" type="radio" value="or" checked="checked"/>OR
<br /><br />
...
<br />
<br />
<h3>Orden:</h3>&nbsp;&nbsp;&nbsp; <input name="opcionOrden" type="radio" value="l.titulo"   checked="checked" />Titulo&nbsp;&nbsp;&nbsp;
<input name="opcionOrden" type="radio" value="a.nom_autor" />Autor
<br />
<br />
